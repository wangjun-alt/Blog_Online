...
class SideBar(models.Model):
    ...
    status = models.PositiveIntegerField(default=1, choices=SIDE_TYPE, verbose_name="状态")
    owner = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="作者")
    created_time = models.DateTimeField(auto_now_add=True, verbose_name="创建时间")
    ...
    @classmethod
    def get_all(cls):
        return cls.objects.filter(status=cls.DISPLAY_HTML)
    #
    # @property
    # def content_html(self):
    #     """直接渲染模板"""
    #     from myblog.models import Post  # 避免循环引用
